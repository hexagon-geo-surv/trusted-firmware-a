...
static const plat_psci_ops_t *lfa_psci_ops __attribute__((section(".lfa_relocatable_data"))) = NULL;
static uintptr_t plat_wr_ep __attribute__((section(".lfa_relocatable_data"))) = 0;
static uint64_t reset_cpu_count __attribute__((section(".lfa_relocatable_data"))) = 0;
