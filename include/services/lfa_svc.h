...
#define LFA_SVC_VERSION			LFA_FID(0x2E0)
#define LFA_SVC_FEATURES		LFA_FID(0x2E1)
#define LFA_SVC_GET_INFO		LFA_FID(0x2E2)
#define LFA_SVC_GET_INVENTORY		LFA_FID(0x2E3)
#define LFA_SVC_PRIME			LFA_FID(0x2E4)
#define LFA_SVC_ACTIVATE		LFA_FID(0x2E5)
#define LFA_SVC_CANCEL			LFA_FID(0x2E6)

/* Check whether FID is in the range */
#define is_lfa_fid(_fid) 				\
	((_fid >= LFA_SVC_VERSION) &&			\
		(_fid <= LFA_SVC_CANCEL))
