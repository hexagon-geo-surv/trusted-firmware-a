...
DECLARE_PER_CPU_BASE(cpu_data_t, percpu_data);
...
#define get_cpu_data(_m)			BASE_THIS_CPU_PTR(percpu_data)->_m
#define set_cpu_data(_m, _v)			BASE_THIS_CPU_PTR(percpu_data)->_m = (_v)
#define get_cpu_data_by_index(_ix, _m)		BASE_FOR_CPU_PTR(percpu_data, _ix)->_m
#define set_cpu_data_by_index(_ix, _m, _v)	BASE_FOR_CPU_PTR(percpu_data, _ix)->_m = (_v)
/* ((cpu_data_t *)0)->_m is a dummy to get the sizeof the struct member _m */
#define flush_cpu_data(_m)	   flush_dcache_range((uintptr_t)	  \
						&(BASE_THIS_CPU_PTR(percpu_data)->_m), \
...
#define flush_cpu_data_by_index(_ix, _m)	\
				   flush_dcache_range((uintptr_t)	  \
					 &(BASE_FOR_CPU_PTR(percpu_data, _ix)->_m),  \
						sizeof(((cpu_data_t *)0)->_m))
